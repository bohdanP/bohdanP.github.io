...
canvas.setBackgroundImage(imgbackground, canvas.renderAll.bind(canvas), {});
  ...
  // Load SVG
  fabric.loadSVGFromURL('svg/69.svg',function(objects,options) {
...
if (options.target.restriction == "form") {
    ...
    //options.target.globalCompositeOperation = 'destination-over';
} else if ( mode == 0) {
...
your_path.restriction = "form";
canvas.isDrawingMode = false;
your_path.perPixelTargetFind = true;
your_path.targetFindTolerance = 4;
your_path.hasBorders = false;
your_path.hasControls = false;
your_path.selectable = false;
your_path.lockMovementX = true;
your_path.lockMovementY = true;
your_path.hoverCursor = 'crosshair';
your_path.evented = false;
